...
class SentimentAnalyzer:
    ...
    def get_exchange_flows_coingecko(self, timeframe="1d"):
        ...
        try:
            ...
            exchanges = ["binance", "coinbase", "kucoin", "ftx", "huobi"]
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    logger.warning(f"Błąd HTTP podczas pobierania danych o BTC z CoinGecko: {response.status_code}")
            except Exception as e:
    ...
    def get_exchange_flows_webscraping(self, timeframe="1d"):
        ...
        try:
            ...
            url = "https://whale-alert.io/alerts"
